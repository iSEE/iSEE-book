...
in which case they should use the various utilities provided by `r Biocpkg("iSEE")` to mediate the interactions with `rObjects` and `pObjects`.
...
see, for example, the `MAPlot` class from the `r Biocpkg("iSEEu")` package.
