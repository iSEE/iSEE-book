...
This proposed class is the basis of the `DynamicReducedDimensionPlot` from the `r Biocpkg("iSEEu")` package.
...
We use functions from the `r BiocStyle::Biocpkg("scater")` package to do the actual heavy lifting of calculating the dimensionality reduction results.
...
SCREENSHOT("screenshots/adaptive-dimred.png")
```
